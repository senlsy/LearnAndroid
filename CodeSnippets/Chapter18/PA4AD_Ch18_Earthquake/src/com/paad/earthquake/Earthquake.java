...
public class Earthquake extends Activity
{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Moved from onCreate -- Retreive the Search View and configure/enable
        // it.
    ...
    private void bindService() {
        bindService(new Intent(this,IEarthquakeService.class), serviceConnection, Context.BIND_AUTO_CREATE);
    }
    
    private ServiceConnection serviceConnection=new ServiceConnection(){
        
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.e("lintest", "onServiceConnected******");
            earthquakeService=IEarthquakeService.Stub.asInterface(service);
            try{
                Log.e("lintest", earthquakeService.getEarthquakes().toString());
