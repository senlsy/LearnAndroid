...
public class MySearchSuggestionsContentProvider extends ContentProvider
{
    ...
    static{
        ...
        SEARCH_SUGGEST_PROJECTION_MAP.put(
                                          "_id", KEY_ID + " AS " + "_id");
        SEARCH_SUGGEST_PROJECTION_MAP.put(
                                          SearchManager.SUGGEST_COLUMN_TEXT_1, KEY_SEARCH_COLUMN + " AS " + SearchManager.SUGGEST_COLUMN_TEXT_1);
        SEARCH_SUGGEST_PROJECTION_MAP.put(
                                          SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID, KEY_ID + " AS " + "SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID, KEY_ID");
    }
