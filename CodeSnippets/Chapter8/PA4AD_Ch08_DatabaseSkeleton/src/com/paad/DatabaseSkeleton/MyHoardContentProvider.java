...
public class MyHoardContentProvider extends ContentProvider
{
    ...
    // correspond to a request for all items, and 詉tems/[rowID]� //represents a
    // single row.
    static{
    ...
    public static final String KEY_GOLD_HOARD_IMAGE_COLUMN="_data";//图片路径
    ...
    public boolean onCreate() {
        ...
        hoardDBOpenHelper=new HoardDBOpenHelper(getContext(), HoardDBOpenHelper.DATABASE_NAME, null, HoardDBOpenHelper.DATABASE_VERSION);
        return true;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        // Values object
        // you must use the null column hack parameter to specify the name of
        // the column
        // that can be set to null.
        String nullColumnHack=null;
        // Insert the values into the table
        long id=db.insert(HoardDBOpenHelper.DATABASE_TABLE, nullColumnHack, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        return db.update(HoardDBOpenHelper.DATABASE_TABLE, values, selection, selectionArgs);
    }
