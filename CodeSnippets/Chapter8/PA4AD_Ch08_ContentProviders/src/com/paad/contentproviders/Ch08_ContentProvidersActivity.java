...
public class Ch08_ContentProvidersActivity extends Activity {
	...
	private String[] getSongListing() {
		...
		String[] projection = new String[] { MediaStore.Audio.AudioColumns.ALBUM, MediaStore.Audio.AudioColumns.TITLE };
	...
	private String performCallerId() {
		 ...
		 */
		String incomingNumber = "15080148662";
	...
	private void insertContactWithIntent() {
		...
		intent.setData(Uri.parse("tel:18120758248"));
		intent.putExtra(ContactsContract.Intents.Insert.NAME, "Sen");
