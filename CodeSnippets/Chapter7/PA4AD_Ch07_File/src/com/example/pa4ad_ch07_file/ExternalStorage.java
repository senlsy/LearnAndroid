 ...
 */
package com.example.pa4ad_ch07_file;
...
public class ExternalStorage extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExternalStoragePrivateFile=createStorageControls("私有的，获取外部文件存储目录",
    ...
    Item createStorageControls(CharSequence label, File path, View.OnClickListener createClick, View.OnClickListener deleteClick) {
