...
public class BodyParamsEntity extends AbstractHttpEntity implements Cloneable
{
    ...
    private boolean dirty=true;// 根据该标志，判断是否需要重新将params转换成content。
    ...
    public BodyParamsEntity(List<NameValuePair> params) throws UnsupportedEncodingException{
        this(params, null);
    }
    ...
    public void writeTo(final OutputStream outStream) throws IOException {
        if(outStream == null){
            throw new IllegalArgumentException("HttpClient OutputStream may not be null");
        }
        refreshContent();
