...
public class OtherUtils
{
    ...
    /**
     * @Description: 从httpResponse中获取文件名
     * @param
     * @return String
    ...
    /**
     *@Title: getCharsetFromHttpRequest
     *@Description:取出http head中的编码key=“Content-Type”
     * @param request
     * @return
     */
    ...
    public static void trustAllHttpsURLConnection() throws NoSuchAlgorithmException, KeyManagementException {
