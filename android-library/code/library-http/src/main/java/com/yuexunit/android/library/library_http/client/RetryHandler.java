...
public class RetryHandler implements HttpRequestRetryHandler
{
    ...
    private static HashSet<Class<?>> exceptionWhiteList=new HashSet<Class<?>>();// 在这个列表总的异常会尝试重发
    private static HashSet<Class<?>> exceptionBlackList=new HashSet<Class<?>>();// 不会重发
    static{
