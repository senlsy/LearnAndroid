...
public class FormBodyPart
{
    ...
    public FormBodyPart(final String name, final ContentBody body){
        ...
        //
        generateContentDisposition(body);// 正文描述信息
        generateContentType(body);// 正文mime类型
        generateTransferEncoding(body);// 传输编码
    }
    ...
    /**
     * @Title: generateContentDisposition
     * @Description:生成Content-Disposition 头部信息
     * @param body
     */
    ...
    /**
     * @Title: generateContentType
     * @Description:生成Content-Type头部信息
     * @param body
     */
    ...
    /**
     * @Title: generateTransferEncoding
     * @Description:生成Content-Transfer-Encoding头部信息
     * @param body
     */
