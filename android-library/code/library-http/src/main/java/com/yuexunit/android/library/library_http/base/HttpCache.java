...
import com.yuexunit.android.library.library_http.cache.LruMemoryCache;
import com.yuexunit.android.library.library_http.client.HttpRequest;


/**
 * Author: wyouflf Date: 13-8-1 Time: 下午12:04 lru算法缓存，加上一个时间有效性。
 */
public class HttpCache
{
    ...
    private final static ConcurrentHashMap<String, Boolean> httpMethod_enabled_map;// 支持缓存的方法
    static{
