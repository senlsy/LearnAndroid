...
public class UserCacheImpl implements UserCache {
    ...
    private static final String DEFAULT_FILE_NAME = "user_";//缓存文件名

    private static final long EXPIRATION_TIME = 60 * 10 * 1000;//缓存有效时间
    ...
    /**
     * 从缓存文件中读取一个user的缓存，返回userEntity
     *
    ...
    /**
     * 将一个userEntity加入到缓存，一个userEntity缓存对应一个file(user_id)
     *
